...
export default function RetroCeramicPage() {
    ...
    try {
      ...
      if (data && data.products) {
        ...
        const filteredProducts = data.products.filter((product: any) => {
          ...
          // Проверяем что это серия Ретро и что артикул заканчивается на 14
          if (!article.endsWith('14')) return false;
  ...
  return (
    <div className="text-black" style={{ backgroundColor: 'var(--background)', minHeight: '100vh', color: 'var(--foreground)' }}>
      ...
      <div className="mb-8">
          <h2 className="text-5xl sm:text-3xl md:text-4xl lg:text-6xl font-bold text-black mb-5">Retro - Коричневый</h2>
          ...
          <span className="text-white">Retro - Коричневый</span>
        </nav>
        </div>
        </div>
