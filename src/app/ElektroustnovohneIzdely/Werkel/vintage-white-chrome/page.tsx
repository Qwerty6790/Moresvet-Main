...
export default function VintageWhiteChromePage() {
    ...
    try {
      ...
      if (data && data.products) {
        ...
        const filteredProducts = data.products.filter((product: any) => {
          ...
          // Проверяем что это серия Vintage и цвет белый матовый хром
          if (!name.includes('vintage')) return false;
          if (!name.includes('белый') || !name.includes('матовый') || !name.includes('хром')) return false;
