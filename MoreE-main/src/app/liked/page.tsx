          ...
          <div className="bg-white rounded-2xl shadow-xl p-12">
            <div className="flex flex-col items-center text-center">
              <div className="w-24 h-24 bg-gray-100 rounded-full flex items-center justify-center mb-6">
                <svg className="w-12 h-12 text-black/40" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/>
                </svg>
              </div>
              <p className="text-2xl font-medium text-black mb-6">{error}</p>
              <Link href="/products" 
                className="inline-flex items-center px-6 py-3 border-2 border-black text-black 
                         rounded-xl hover:bg-black hover:text-white transition-colors text-lg font-medium">
                Перейти в каталог
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {likedProducts.map((product) => (
                <motion.div
                  ...
                  whileHover={{ y: -5 }}
                >
                  <div onClick={() => handleProductClick(product.article, product.source)}
                  ...
                  <div className="absolute inset-x-0 bottom-0 p-4 opacity-0 group-hover:opacity-100 
            ...
            {likedProducts.length > 0 && (
              <div className="flex justify-center mt-10">
                <button
                  ...
                  className="px-8 py-4 border-2 border-black text-black rounded-xl text-lg 
