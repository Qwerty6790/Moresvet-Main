...
export const CatalogOfLightStar: React.FC<CatalogOfProductsProps> = ({ products, viewMode }) => {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
      {products
        .filter(product => product.imageAddress && product.imageAddress.trim() !== '' && /\.(jpg|jpeg|png|webp|gif)$/i.test(product.imageAddress))
        .map((product, index) => {
              ...
              <div className="p-4 space-y-2">
                ...
                <div className="flex items-center justify-between text-sm">
                  ...
                  <div className="flex items-center space-x-1">
                    <div className={`w-1.5 h-1.5 rounded-full ${stockCount > 0 ? 'bg-green-500' : 'bg-red-500'}`} />
