...
const Header: React.FC = () => {
    ...
    >
      ...
      <div className="container mx-auto px-4 lg:px-16 flex justify-between items-center transition-all duration-300">
        ...
        <nav className="hidden lg:flex space-x-8 font-semibold text-lg">
          <a href="/products" className="text-gray-800 transition duration-300 hover:translate-x-5  hover:text-neutral-700 ">
            Каталог
          </a>
          <a href="/map" className="text-gray-800  transition duration-300 hover:translate-x-5  hover:text-neutral-700 ">
            На карте
          </a>
          <a href="/about" className="text-gray-800  transition duration-300 hover:translate-x-5  hover:text-neutral-700 ">
            О нас
          </a>
        </nav>
  ...
  {isMenuOpen && (
    <motion.div
      className="fixed top-0 z-50 left-0 h-screen w-1/2 bg-black text-white shadow-xl"
      initial={{ x: "-100%" }}
      animate={{ x: 0 }}
      exit={{ x: "-100%" }}
