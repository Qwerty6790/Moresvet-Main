...
const Header = () => {
  ...
  return (
    <header className={`bg-white py-6 border-b border-gray-300 fixed top-0 w-full z-50 ${isScrolled ? "shadow-lg" : ""}`}>
      <div className="container mx-auto flex flex-wrap items-center justify-between px-4">
        <div className="flex text-sm font-semibold items-center space-x-2 md:space-x-4 w-full md:w-auto justify-between md:justify-start">
          ...
          <a
            ...
            className="hidden sm:block text-sm text-black hover:underline truncate"
          >
            s.roma86@mail.ru
          </a>
        </div>
      ...
      <div className="container mx-auto flex items-center justify-between mt-4 px-4">
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-2 md:space-x-6">
            <button className="bg-black flex text-sm md:text-2xl text-white px-4 py-2 md:px-8 md:py-2 rounded truncate">
  ...
  {cartCount > 0 && (
    <span className="absolute -top-2 -right-2 bg-neutral-400 text-black text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center border border-gray-300 shadow-sm">
      {cartCount}
          ...
          <div className="relative flex items-center text-black hover:text-gray-700">
          </div>
